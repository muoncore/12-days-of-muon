...
This is implementing Muon in a native C++ library, with support for bindings into many other languages.
...
repositories {
    jcenter()
    maven { url 'https://simplicityitself.artifactoryonline.com/simplicityitself/repo' } <3>
}
...
http://www.simplicityitself.io/our%20team/2016/11/03/make-developer-api.html[Read More @ Simplicity Itself]
****
